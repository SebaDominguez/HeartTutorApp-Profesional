...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-239675:/callback' : 'http://localhost:8100/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-239675:/logout' : 'http://localhost:8100/implicit/logout';
    const clientId = '0oa1kxqy2m5xwJ1u2357';
    const issuer = 'https://dev-239675.okta.com/oauth2/default';
